...
export default function AssessmentGeneratorPage() {
  ...
  async function generate() {
    ...
    const response = await fetch("/api/assessment-generator", { method:"POST", headers:{"Content-Type":"application/json"}, body:JSON.stringify(form) });
