...
export default function DocumentAssistantPage() {
  ...
  async function saveDraft() {
    ...
    const response = await fetch("/api/ai/document-assistant/save", { method:"POST", headers:{"Content-Type":"application/json"}, body:JSON.stringify({ title:template.name, content:draft }) });
    const data = await response.json().catch(()=>({}));
    setSaving(false);
