  ...
  return (
    <div className="app-shell">
      ...
      <main className="main" id="dashboard">
        ...
        <section className="welcome-banner"><div><span className="welcome-kicker">YOUR TEACHING COPILOT</span><h2>Less paperwork.<br />More teaching.</h2><p>Keep your tasks, documents, and lesson planning moving from one calm workspace.</p><div className="welcome-actions"><a className="primary-button" href="/ai/document-assistant">Ask CoTeacher <span>→</span></a><a className="banner-link" href="/tasks">View today’s tasks</a></div></div><div className="welcome-illustration" aria-hidden="true"><div className="spark spark-one">✦</div><div className="book"><span></span><span></span></div><div className="spark spark-two">✦</div></div></section>
        ...
        <section className="grid">
          ...
          <div className="card" id="assistant"><div className="card-title"><h2>Quick actions</h2><span className="card-accent">Get things done</span></div><div className="quick-actions"><a className="quick-action" href="/ai/document-assistant"><span><b>✦</b> Generate a document with AI</span><span>→</span></a><a className="quick-action" href="/lesson-planner"><span><b>▱</b> Create a lesson plan</span><span>→</span></a><a className="quick-action" href="/tasks"><span><b>✓</b> Add a task or deadline</span><span>→</span></a></div></div>
