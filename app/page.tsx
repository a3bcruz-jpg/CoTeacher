    ...
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <nav className="nav" aria-label="Main navigation">
          ...
          <a className="nav-item" href="/tasks">✓ <span>My Tasks</span></a>
          ...
          <a className="nav-item" href="/onboarding">♙ <span>My Profile</span></a>
        </nav>
      ...
      <main className="main" id="dashboard">
        ...
        <section className="stats" aria-label="Workspace summary">
          <div className="card stat-card"><div className="stat-icon task-icon">✓</div><div><div className="stat-label">Tasks due today</div><div className="stat-value">{dueToday}</div></div></div>
          ...
          <div className="card stat-card"><div className="stat-icon ai-icon">✦</div><div><div className="stat-label">AI generations</div><div className="stat-value">{aiGenerations}</div></div></div>
        </section>
